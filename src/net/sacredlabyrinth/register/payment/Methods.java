package net.sacredlabyrinth.register.payment;

import net.sacredlabyrinth.register.payment.methods.BOSE6;
import net.sacredlabyrinth.register.payment.methods.BOSE7;
...
public class Methods {
    ...
    private void _init() {
        this.addMethod("iConomy", new net.sacredlabyrinth.register.payment.methods.iCo4());
        this.addMethod("iConomy", new net.sacredlabyrinth.register.payment.methods.iCo5());
        this.addMethod("BOSEconomy", new BOSE6());
        this.addMethod("BOSEconomy", new BOSE7());
        this.addMethod("Essentials", new net.sacredlabyrinth.register.payment.methods.EE17());
    }
