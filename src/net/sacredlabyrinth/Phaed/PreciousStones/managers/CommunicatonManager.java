...
public class CommunicatonManager
{
	...
	if (plugin.settings.logPlace)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} placed an unbreakable block [{1}|{2} {3} {4}]", new Object[]{player.getName(), unbreakable.getTypeId(), unbreakable.getX(), unbreakable.getY(), unbreakable.getZ()});
	...
	if (plugin.settings.logPlace)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} placed a {1} force-field [{2}|{3} {4} {5}]", new Object[]{player.getName(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logPlace)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} placed a breakable {1} force-field [{2}|{3} {4} {5}]", new Object[]{player.getName(), fieldsettings.getTitle(), fieldblock.getType(), fieldblock.getX(), fieldblock.getY(), field.getZ()});
	...
	if (plugin.settings.logDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} destroyed his own unbreakable block [{1}|{2} {3} {4}]", new Object[]{player.getName(), unbreakableblock.getType(), unbreakableblock.getX(), unbreakableblock.getY(), unbreakableblock.getZ()});
	...
	if (plugin.settings.logDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} destroyed his {1} force-field [{2}|{3} {4} {5}]", new Object[]{player.getName(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} destroyed {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{player.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} destroyed {1}''s breakable {2} force-field [{3}|{4} {5} {6}]", new Object[]{player.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logBypassPlace)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-placed a block inside {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{player.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logBypassPlace)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-placed an unbreakable block inside {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{player.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logBypassDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-destroyed a block {1} in {2}''s {3} force-field [{4}|{5} {6} {7}]", new Object[]{player.getName(), (new Vec(block)).toString(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logBypassDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-destroyed {1}''s unbreakable block [{2}|{3} {4} {5}]", new Object[]{player.getName(), unbreakable.getOwner(), unbreakable.getType(), unbreakable.getX(), unbreakable.getY(), unbreakable.getZ()});
	...
	if (plugin.settings.logBypassDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-destroyed {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{player.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logEntry)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted entry into {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{player.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logFire)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to light fire in {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{player.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logPlace)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted place a block {1} in {2}''s {3} force-field [{4}|{5} {6} {7}]", new Object[]{player.getName(), (new Vec(block)).toString(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to destroy {1}''s unbreakable block [{2}|{3} {4} {5}]", new Object[]{player.getName(), unbreakable.getOwner(), unbreakable.getType(), unbreakable.getX(), unbreakable.getY(), unbreakable.getZ()});
	...
	if (plugin.settings.logDestroy)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to destroy {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{player.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logDestroyArea)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to destroy a block {1} inside {2}''s {3} force-field [{4}|{5} {6} {7}]", new Object[]{player.getName(), (new Vec(damagedblock)).toString(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logConflictPlace)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to place an unbreakable block {1} conflicting with {2}''s {3} force-field [{4}|{5} {6} {7}]", new Object[]{player.getName(), (new Vec(block)).toString(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logConflictPlace)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to place a force-field {1} conflicting with {2}''s {3} force-field [{4}|{5} {6} {7}]", new Object[]{player.getName(), (new Vec(block)).toString(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logPvp)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} tried to attack {1} in {2}''s {3} force-field [{4}|{5} {6} {7}]", new Object[]{attacker.getName(), victim.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logBypassPvp)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-attack {1} in {2}''s {3} force-field [{4}|{5} {6} {7}]", new Object[]{attacker.getName(), victim.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logPvp)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} tried to place lava in {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{attacker.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logBypassPvp)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-lava-place in {1}''s {2} force-field [{3}|{4} {5} {6}]", new Object[]{attacker.getName(), field.getOwner(), fieldsettings.getTitle(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logUnprotectable)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to place an unprotectable block [{1}|{2} {3} {4}] near [{5}|{6} {7} {8}]", new Object[]{player.getName(), unprotectableblock.getType(), unprotectableblock.getX(), unprotectableblock.getY(), unprotectableblock.getZ(), protectionblock.getType(), protectionblock.getX(), protectionblock.getY(), protectionblock.getZ()});
	...
	if (plugin.settings.logUnprotectable)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to protect an unprotectable block [{1}|{2} {3} {4}]", new Object[]{player.getName(), touchingblock.getType(), touchingblock.getX(), touchingblock.getY(), touchingblock.getZ()});
	...
	if (plugin.settings.logUnprotectable)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to protect an unprotectable block [{1}|{2} {3} {4}] inside a force-field [{5}|{6} {7} {8}]", new Object[]{player.getName(), unprotectableblock.getType(), unprotectableblock.getX(), unprotectableblock.getY(), unprotectableblock.getZ(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logUnprotectable)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} attempted to place a force-field [{1}] but an unprotectable was found in the area [{2}|{3} {4} {5}]", new Object[]{player.getName(), fieldtypeblock.getType(), unprotectableblock.getType(), unprotectableblock.getX(), unprotectableblock.getY(), unprotectableblock.getZ()});
	...
	if (plugin.settings.logUnprotectable)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-placed an unprotectable block [{1}|{2} {3} {4}] near [{5}|{6} {7} {8}]", new Object[]{player.getName(), unprotectableblock.getType(), unprotectableblock.getX(), unprotectableblock.getY(), unprotectableblock.getZ(), protectionblock.getType(), protectionblock.getX(), protectionblock.getY(), protectionblock.getZ()});
	...
	if (plugin.settings.logUnprotectable)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-protected an unprotectable block [{1}|{2} {3} {4}]", new Object[]{player.getName(), placedblock.getType(), placedblock.getX(), placedblock.getY(), placedblock.getZ()});
	...
	if (plugin.settings.logUnprotectable)
	    PreciousStones.log.log(Level.INFO, "[ps] {0} bypass-placed an unprotectable block [{1}|{2} {3} {4}] inside a force-field [{5}|{6} {7} {8}]", new Object[]{player.getName(), unprotectableblock.getType(), unprotectableblock.getX(), unprotectableblock.getY(), unprotectableblock.getZ(), field.getType(), field.getX(), field.getY(), field.getZ()});
	...
	if (plugin.settings.logUnprotectable)
	    PreciousStones.log.log(Level.INFO, "[ps] {0}bypass-placed a force-field [{1}] in an area with an unprotectable block [{2}|{3} {4} {5}]", new Object[]{player.getName(), fieldtypeblock.getType(), unprotectableblock.getType(), unprotectableblock.getX(), unprotectableblock.getY(), unprotectableblock.getZ()});
