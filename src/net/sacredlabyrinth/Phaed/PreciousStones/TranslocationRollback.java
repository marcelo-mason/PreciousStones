 ...
 * @author phaed
 */
public class TranslocationRollback implements Runnable
{
     ...
     * @param world
     */
    public TranslocationRollback(Queue<TranslocationBlock> translocationQueue, World world)
    {
    ...
    public void run()
    {
        ...
        while (i < 100 && !translocationQueue.isEmpty())
        {
            ...
            PreciousStones.getInstance().getTranslocationManager().undoTranslocationBlock(tb, world);
            i++;
        }
        ...
        if (translocationQueue.isEmpty())
        {
            while (i < 200 && !dependentQueue.isEmpty())
            {
                ...
                PreciousStones.getInstance().getTranslocationManager().undoTranslocationBlock(gb, world);
                i++;
            }
