            ...
            if (isRented())
            {
                ...
                if (s != null)
                {
                    if (s.isRentable() || s.isShareable())
                    {
                        ...
                        {
                            Player closest = Helper.getClosestPlayer(getLocation(), 64);
